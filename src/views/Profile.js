...
import {FlatList, Image, ImageBackground, Text, TextInput, TouchableHighlight, View} from "react-native";
        ...
        return(
            <SafeAreaView forceInset={{ top: 'never', bottom:'never' }} style={styles.container}>
                <KeyboardAwareScrollView style={{backgroundColor:'rgb(248,249,248)'}}>
                    <ImageBackground style={{width:"100%",height:200}} source={require('../assets/rename.gif')}>
                    ...
                    <View style={{alignItems:"center",marginTop:25}}>
                        <Text style={styles.textUserName}>Benjamin Rees</Text>
                        <Text style={styles.textDesignation}>CEO of the famous company</Text>
                        ...
                        <Text style={styles.textDescription}>A creative & innovative business leader, with a meticulous management style.
                            Specialising in business start-ups, market research and brand identity. Chief Marketing Officer at The Famous Company</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.viewLoginButton}>
                        ...
                        <TouchableHighlight  underlayColor="black" onPress={null} style={[styles.imageButton]}>
                            <Text></Text>
                        </TouchableHighlight>
