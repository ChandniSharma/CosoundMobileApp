...
export default class ForgotPasswordComponent extends Component {
    ...
    // fadeInMainView = () => this.refs.mainView.fadeIn(2000).then(setTimeout(() => {
    //     this.fadeInView2();
    // }, 10))
    ...
    fadeInUpView3 = () => this.refs.view3.fadeInUp().then(endState => console.log(endState.finished ? 'fadein finished' : " cancelled"))
                ...
                <KeyboardAwareScrollView style={{ backgroundColor: 'rgb(245,245,245)', flex: 0.9 }}>
                    ...
                    <Animatable.View ref={"mainView"} style={{ flex: 1, backgroundColor: 'transparent', width: '100%' }}>
                        ...
                        <View>
                            ...
                            <Animatable.Text animation="fadeInUp" style={styles.loginText}> Forgot Password?</Animatable.Text>
                            ...
                            <Animatable.View ref={'view3'} style={styles.viewRecoverButton}>
